...
#include "zend_lazy_objects.h" // for zend_object_is_lazy_proxy()
#include "zend_object_handlers.h" // for zend_check_protected()
...
static zend_always_inline ZEND_ATTRIBUTE_PURE bool zend_check_method_accessible(const zend_function *fn, const zend_class_entry *scope)
{
