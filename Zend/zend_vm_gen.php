...
function gen_vm_opcodes_header(
    ...
    $str .= "\n";
    $str .= "BEGIN_EXTERN_C()\n\n";
    $str .= "ZEND_API ZEND_ATTRIBUTE_CONST const char* ZEND_FASTCALL zend_get_opcode_name(zend_uchar opcode);\n";
    $str .= "ZEND_API ZEND_ATTRIBUTE_CONST uint32_t ZEND_FASTCALL zend_get_opcode_flags(zend_uchar opcode);\n";
    $str .= "ZEND_API ZEND_ATTRIBUTE_PURE zend_uchar zend_get_opcode_id(const char *name, size_t length);\n\n";
    $str .= "END_EXTERN_C()\n\n";
